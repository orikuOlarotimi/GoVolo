            ...
            <div className="sticky top-20 space-y-4">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-center gap-3 border border-border rounded-xl px-4 py-3 hover:border-[rgb(14,168,230)]/40 transition-colors cursor-pointer">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-calendar h-4 w-4 text-primary shrink-0"
                        >
                          <path d="M8 2v4"></path>
                          <path d="M16 2v4"></path>
                          <rect
                      ...
                      <div className="flex items-center justify-between border border-border rounded-xl px-4 py-3">
                        ...
                        <div className="flex items-center gap-2">
                          <button className="w-7 h-7 rounded-lg border border-border flex items-center justify-center hover:bg-muted text-foreground font-bold transition-colors">
                            −
                          </button>
                    ...
                    <div className="bg-muted/50 rounded-xl p-4 mb-4 space-y-2">
                      ...
                      <div className="flex justify-between font-bold">
                        ...
                        <span className="text-primary">$1,048</span>
                      </div>
                    </div>
                    <a
                      href="/BookTripPage"
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-phone h-3.5 w-3.5 text-primary"
                        >
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-mail h-3.5 w-3.5 text-primary"
                        >
                          <rect
                            width="20"
                            height="16"
              ...
              <div className="opacity-100 transform-none">
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="bg-muted/50 border border-border rounded-xl p-3 text-center">
                    <p className="text-xs font-bold text-primary">Instant</p>
